...
{{--                        end of row--}}
                        <div class="row">
                            <div class="col-md-12">
                                <p>{{__('site.final_total')}}: <span class="total-price"></span></p>
                            </div>
                        </div>
                        {{--  end of row--}}
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-primary btn-sm form-control disabled add-order-form-btn "><i class="fa fa-plus"></i> {{__('site.add_order')}}</button>
                            </div>
                        </div>
                        {{--  end of row--}}
                        </form>
